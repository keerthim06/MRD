(function () {
    ...
    angular.module("app", ["ngRoute", "ngAnimate", "ui.bootstrap", "easypiechart", "mgo-angular-wizard", "textAngular", "ui.tree", "ngMap", "ngTagsInput", "app.ui.ctrls", "app.ui.directives", "app.ui.services", "app.controllers", "app.directives", "app.form.validation", "app.ui.form.ctrls", "app.ui.form.directives", "app.tables", "app.map", "app.task", "app.localization", "app.chart.ctrls", "app.chart.directives", "app.page.ctrls"]).config(["$routeProvider", function ($routeProvider) {
        return $routeProvider.when("/", {redirectTo: "/dashboard"}).when("/dashboard", {templateUrl: "Partials/dashboard.html"}).when("/ui/typography", {templateUrl: "Partials/ui/typography.html"}).when("/ui/buttons", {templateUrl: "Partials/ui/buttons.html"}).when("/ui/icons", {templateUrl: "Partials/ui/icons.html"}).when("/ui/grids", {templateUrl: "Partials/ui/grids.html"}).when("/ui/widgets", {templateUrl: "Partials/ui/widgets.html"}).when("/ui/components", {templateUrl: "Partials/ui/components.html"}).when("/ui/timeline", {templateUrl: "Partials/ui/timeline.html"}).when("/ui/nested-lists", {templateUrl: "Partials/ui/nested-lists.html"}).when("/ui/pricing-tables", {templateUrl: "Partials/ui/pricing-tables.html"}).when("/forms/elements", {templateUrl: "Partials/forms/elements.html"}).when("/forms/layouts", {templateUrl: "Partials/forms/layouts.html"}).when("/forms/validation", {templateUrl: "Partials/forms/validation.html"}).when("/forms/wizard", {templateUrl: "Partials/forms/wizard.html"}).when("/maps/gmap", {templateUrl: "Partials/maps/gmap.html"}).when("/maps/jqvmap", {templateUrl: "Partials/maps/jqvmap.html"}).when("/tables/static", {templateUrl: "Partials/tables/static.html"}).when("/tables/responsive", {templateUrl: "Partials/tables/responsive.html"}).when("/tables/dynamic", {templateUrl: "Partials/tables/dynamic.html"}).when("/charts/others", {templateUrl: "Partials/charts/charts.html"}).when("/charts/morris", {templateUrl: "Partials/charts/morris.html"}).when("/charts/flot", {templateUrl: "Partials/charts/flot.html"}).when("/mail/inbox", {templateUrl: "Partials/mail/inbox.html"}).when("/mail/compose", {templateUrl: "Partials/mail/compose.html"}).when("/mail/single", {templateUrl: "Partials/mail/single.html"}).when("/pages/features", {templateUrl: "Partials/pages/features.html"}).when("/pages/signin", {templateUrl: "Partials/pages/signin.html"}).when("/pages/signup", {templateUrl: "Partials/pages/signup.html"}).when("/pages/forgot", {templateUrl: "Partials/pages/forgot-password.html"}).when("/pages/lock-screen", {templateUrl: "Partials/pages/lock-screen.html"}).when("/pages/profile", {templateUrl: "Partials/pages/profile.html"}).when("/404", {templateUrl: "Partials/pages/404.html"}).when("/pages/500", {templateUrl: "Partials/pages/500.html"}).when("/pages/blank", {templateUrl: "Partials/pages/blank.html"}).when("/pages/invoice", {templateUrl: "Partials/pages/invoice.html"}).when("/pages/services", {templateUrl: "Partials/pages/services.html"}).when("/pages/about", {templateUrl: "Partials/pages/about.html"}).when("/pages/contact", {templateUrl: "Partials/pages/contact.html"}).when("/tasks", {templateUrl: "Partials/tasks/tasks.html"}).otherwise({redirectTo: "/404"})
    }])
}.call(this), function () {
